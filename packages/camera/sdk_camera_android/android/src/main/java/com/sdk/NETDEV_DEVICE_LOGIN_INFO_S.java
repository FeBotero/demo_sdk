...
public class NETDEV_DEVICE_LOGIN_INFO_S {
    ...
    {
        public static final int NETDEV_LOGIN_PROTO_ONVIF             = 0;           /* 以ONVIF协议接入 -> Acceso mediante protocolo ONVIF */
        public static final int NETDEV_LOGIN_PROTO_PRIVATE           = 1;           /* 以私有协议接入 -> Acceso mediante protocolo privado */
    }
